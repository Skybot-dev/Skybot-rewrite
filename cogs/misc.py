...
class Misc(commands.Cog, name="Misc"):
    ...
    def __init__(self, bot):
        self.bot = bot
        self.client = TrelloClient(api_key=get_config()["trello"]["api_key"], api_secret=get_config()["trello"]["api_secret"])
        self.my_board = self.client.get_board(get_config()["trello"]["board_id"])
